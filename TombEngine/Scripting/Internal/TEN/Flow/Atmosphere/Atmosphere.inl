namespace TEN::Scripting
{
	...
	@pragma nostrip
	*/
	inline void RainProfile::Register(sol::table& parent)
	{
	...
	@pragma nostrip
	*/
	inline void WeatherProfile::Register(sol::table& parent)
	{
	...
	@pragma nostrip
	*/
	inline void WindProfile::Register(sol::table& parent)
	{
	...
	@pragma nostrip
	*/
	inline void AuroraProfile::Register(sol::table& parent)
	{
	...
	@pragma nostrip
	*/
	inline void Atmosphere::Register(sol::table& parent)
	{
	...
	inline void AuroraProfile::SetColorA(Types::ScriptColor const& color)
	{
		ColorAR = color.GetR();
		ColorAG = color.GetG();
		ColorAB = color.GetB();
	...
	inline void AuroraProfile::SetColorB(Types::ScriptColor const& color)
	{
		ColorBR = color.GetR();
		ColorBG = color.GetG();
		ColorBB = color.GetB();
	...
	inline void AuroraProfile::SetColorC(Types::ScriptColor const& color)
	{
		ColorCR = color.GetR();
		ColorCG = color.GetG();
		ColorCB = color.GetB();
	...
	inline Types::ScriptColor AuroraProfile::GetColorA() const
	{
		return Types::ScriptColor{ ColorAR, ColorAG, ColorAB };
	}

	inline Types::ScriptColor AuroraProfile::GetColorB() const
	{
		return Types::ScriptColor{ ColorBR, ColorBG, ColorBB };
	}

	inline Types::ScriptColor AuroraProfile::GetColorC() const
	{
		return Types::ScriptColor{ ColorCR, ColorCG, ColorCB };
	}
}
